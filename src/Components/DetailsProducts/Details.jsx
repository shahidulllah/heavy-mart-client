    ...
    return (
        <div>
            <div className="flex flex-col items-center justify-center p-5 lg:pt-16">
                <h1 className="text-4xl lg:text-5xl font-bold text-center"><u>Products Details</u></h1>
            </div>
                    ...
                    <div className="flex flex-col lg:flex lg:flex-row border items-center justify-center gap-6 shadow-2xl p-4 rounded-lg lg:p-9"><img className="  rounded-lg h-[40vh]" src={product.image} alt="" />
                        <div className="">
                            <div className="bg-purple-100 p-5 mb-6 rounded-xl">
                                <p className="text-center text-purple-800 text-3xl font-extrabold">{product.productName}</p>
                            ...
                            <div className="text-start flex ml-12 gap-3 mt-3 items-center">
                            <button type="button" className="flex items-center justify-center w-3/12 p-3 font-semibold tracking-wide rounded-md bg-violet-400 text-gray-900 hover:bg-violet-600">Buy Now</button>
                            </div>
