        ...
        <div data-aos="zoom-in" data-aos-duration="2000" className=" p-5 lg:p-16 bg-black text-white">
                    ...
                    <aside className="lg:row-span-2 col-span-2 md:col-span-4 lg:col-span-1 mb-6 flex flex-col justify-center space-y-2 h-full">
                        ...
                        <Link to="/">
                            <div className="flex flex-col justify-center  items-center gap-1">
                                <h1 className="  font-bold lg:text-3xl ">Heavy Mart</h1>
                            </div>
                        </Link>
                        </div>
                        <p className="text-center">Stay with us to buy original products</p>
                    </aside>
            ...
            <div>
                <footer className="footer footer-center mt-20 -mb-3">
                    <aside>
                        <p>Copyright © 2024 - All right reserved by Heavy Mart</p>
                    </aside>
                </footer>
            </div>
        </div>
